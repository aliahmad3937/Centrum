...
import com.cc.cenntrum.databinding.ActivityMapBoxTurnByTurnBinding
import com.cc.cenntrum.utils.MapUtils
 ...
 */
class MapBoxTurnByTurnActivity : AppCompatActivity() {
     ...
     */
    private lateinit var binding: ActivityMapBoxTurnByTurnBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_map_box_turn_by_turn)
        ...
        Handler().postDelayed({
            findRoute(Point.fromLngLat(MapUtils.destinationLongitude, MapUtils.destinationLatitude))
        }
        ,1000)
            ...
            mapboxReplayer.pushEvents(
                listOf(
                    ReplayRouteMapper.mapToUpdateLocation(
                        eventTimestamp = 0.0,
                        point = Point.fromLngLat(MapUtils.originLongitude, MapUtils.originLatitude)
                    )
                )
            )
